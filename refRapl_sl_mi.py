...
class RunnerConfig:
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        tool = FactorModel("tool", ['runCC.sh','runNoTools.sh','runPerf.sh','runPowerjoular.sh','runRefKern.sh','runRefUser.sh','runScaphandre.sh','runTurbostat.sh'])
        # tool = FactorModel("tool", ['runRefKern.sh'])
        benchmark = FactorModel("benchmark", ['sl','mi'])
